...
export const Snark = (props?: FlexProps) => {
    ...
    // deps intentionally omitted — this is for debugging
    useEffect(() => {
        if (!gui) return;
    ...
    function TorusKnot(_props: ThreeElements["mesh"]) {
        ...
        return (
            <mesh ref={meshRef} {..._props}>
                <torusKnotGeometry args={[tweakables.radius, tweakables.tube, 128, 32]} />
    ...
    return (
        <Flex id="canvas-container" className={styles.container} {...props}>
            <Flex width="100%" height="100vh" align="center" justify="center">
                <Canvas>
                    ...
                    {tweakables.showAscii && (
                        <AsciiRenderer
                            renderIndex={1}
                            fgColor={tweakables.useMeshColor ? tweakables.color : "var(--accent-2)"}
                            bgColor="transparent"
                            // characters="█▓▒░ "
                            characters=" ░▒▓█"
                        />
